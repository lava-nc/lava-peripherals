...
class SwipeDetector:
    ...
    def __init__(self,
        ...
        if self.use_loihi2:
            ...
            run_cfg = Loihi2SimCfg(
                exception_proc_model_map={Dense: PyDenseModelBitAcc, Sparse: PySparseModelBitAcc,
    ...
    def _create_processes(self) -> None:
        ...
        print("out sparses")
        print(self.w_out_right.shape)

        self.out_lif_left = LIF(shape=(self.num_out_neurons,), **self.lif_config)
        self.out_lif_right = LIF(shape=(self.num_out_neurons,), **self.lif_config)
        ...
        if self.use_loihi2:
            ...
            self.out_adapter_right = NxToPyAdapter(shape=(self.num_out_neurons,))
