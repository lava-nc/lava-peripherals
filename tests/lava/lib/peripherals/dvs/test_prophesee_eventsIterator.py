...
from lava.lib.peripherals.dvs.prophesee_evetniterator import PyPropheseeEventIteratorModel
from lava.lib.peripherals.dvs.prophesee_evetniterator import PropheseeEventsIterator
from lava.lib.peripherals.dvs.prophesee_evetniterator import EventsIteratorWrapper
...
class TestPropheseeEventsIteratorwithEventIterator(unittest.TestCase):
    def test_init(self):
        """Test that the PropheseeEventsIterator Process is instantiated correctly."""
        num_output_time_bins = 3
        mv_iterator = EventsIterator(input_path=SEQUENCE_FILENAME_RAW, delta_t=1000)
    ...
    def test_invalid_parameters(self):
        """Test that instantiating the PropheseeEventsIterator Process with an invalid
...
class TestPyPropheseeEventIteratorModel(unittest.TestCase):
    ...
    def test_base_functionality_file(self):
        """Test that running a PropheseeEventsIterator works using a data file."""
        mv_iterator = EventsIterator(input_path=SEQUENCE_FILENAME_RAW, delta_t=1000)
        height, width = mv_iterator.get_size()
        del mv_iterator
    ...
    @unittest.skip("sometimes error")
    def test_base_functionality_dat_file(self):
        """Test that running a PropheseeEventsIterator works using a dat data file."""
